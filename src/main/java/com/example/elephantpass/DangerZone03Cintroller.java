...
public class DangerZone03Cintroller {
    ...
    public Label dangerZone03ID;
    public Label dangerZone03Name;
    public Label dangerZone03Location;
    public JFXTextArea dangerZone03Description;
    @FXML
