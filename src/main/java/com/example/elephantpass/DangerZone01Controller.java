...
public class DangerZone01Controller {
    ...
    public Label dangerZone01ID;
    public Label dangerZone01Name;
    public Label dangerZone01Location;
    public JFXTextArea dangerZone01Description;
