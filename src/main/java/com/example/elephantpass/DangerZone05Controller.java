...
public class DangerZone05Controller {
    ...
    public Label dangerZone05ID;
    public Label dangerZone05Name;
    public Label dangerZone05Location;
    public JFXTextArea dangerZone05Description;
