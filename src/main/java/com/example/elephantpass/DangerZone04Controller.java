...
public class DangerZone04Controller {
    ...
    public Label dangerZone04ID;
    public Label dangerZone04Name;
    public Label dangerZone04Location;
    public JFXTextArea dangerZone04Description;
